...
import { WA_NUMBER, WA_DEFAULT_MSG, TRANSFER_DISCOUNT_PCT } from '../config/constants';

function AnnouncementBar() {
  const waUrl = `https://wa.me/${WA_NUMBER}?text=${encodeURIComponent(WA_DEFAULT_MSG)}`;
  return (
    <div className="bg-blue-600 text-white text-xs py-2 px-4 text-center">
      <span className="font-semibold">🏦 {TRANSFER_DISCOUNT_PCT}% OFF</span>
  ...
  return (
    <a href={waUrl} target="_blank" rel="noopener noreferrer"
       ...
       className="fixed bottom-6 right-6 z-50 flex items-center gap-2.5
                  bg-[#25d366] hover:bg-[#1fbb59] text-white
