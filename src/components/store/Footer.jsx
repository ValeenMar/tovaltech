    ...
    <footer className="bg-gray-900 text-gray-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center gap-2.5 mb-4">
              ...
              <span className="text-lg font-bold tracking-tight text-white">
                Toval<span className="text-blue-400">Tech</span>
              </span>
            </div>
            <p className="text-sm text-gray-400 max-w-xs leading-relaxed">
              Tu tienda de tecnología y computación en Buenos Aires. Stock actualizado, precios competitivos y envío a todo el país.
            </p>
            {/* WhatsApp en footer */}
            <a href={waUrl} target="_blank" rel="noopener noreferrer"
               className="inline-flex items-center gap-2 mt-4 text-sm text-[#25d366] hover:text-[#1fbb59] transition-colors font-medium">
          ...
          <div>
            ...
            <div className="flex flex-col gap-3">
              <a href="mailto:valentin@toval-tech.com"
                ...
                valentin@toval-tech.com
              </a>
              <a href={`tel:+5491123413674`}
                 className="flex items-center gap-2.5 text-sm text-gray-400 hover:text-white transition-colors">
        ...
        <div className="border-t border-gray-800 mt-10 pt-6 flex flex-col sm:flex-row justify-between items-center gap-2 text-xs text-gray-500">
          <span>© 2026 TovalTech. Todos los derechos reservados.</span>
